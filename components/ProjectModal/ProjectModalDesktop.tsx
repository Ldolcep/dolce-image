  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <motion.div
          ref={modalRef}
          className="relative mx-4 w-full max-w-5xl max-h-[80vh] rounded-lg bg-white shadow-xl overflow-hidden"
        ...
        >
          <div className="grid grid-cols-2 h-full">
            {/* Colonne image */}
            <div className="aspect-[4/5] relative flex-shrink-0 bg-gray-50">
              <div className="w-full h-full flex items-center justify-center">
                <div className="carousel-container w-full h-full" style={{ position: 'relative' }}>
                  <div className="carousel-slides-wrapper w-full h-full" style={{ position: 'relative' }}>
                    <AnimatePresence mode="wait" custom={direction}>
                      ...
                      >
                        <div className="modal-image-wrapper w-full h-full" style={{ position: 'relative' }}>
            ...
            <div className="flex flex-col min-h-0 h-full">
              ...
              {/* Footer (optionnel, exemple) */}
              {/* <div className="border-t border-gray-200 p-6 flex-shrink-0">Footer ici</div> */}
            </div>
          </div>
        </motion.div>
      </motion.div>
