...
export default function ProjectModal({ project, isOpen, onClose }: ProjectModalProps) {
  ...
  return (
    ...
    >
      <div 
        ref={modalRef} 
        className={`modal-content ${isAnimating ? "open" : ""} flex flex-col md:flex-row`}
      >
        {/* Image Section */}
        <div className="w-full md:w-1/2 relative">
          ...
          <div className="flex justify-center items-center mt-4 mb-4 space-x-3">
            <button 
        ...
        {/* Close button */}
        <button
          className="absolute top-4 right-4 z-10 bg-blue-600 text-white rounded-full p-2 hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          onClick={onClose}
