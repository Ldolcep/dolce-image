// ProjectModalMobile.tsx - Indentation Corrigée
"use client"
...
export default function ProjectModalMobile({ project, isOpen, onClose }: ProjectModalMobileProps) {
  ...
  }, [touchStart, touchEnd, isSwiping, swipeRotation, MIN_SWIPE_DISTANCE, handleNext, handlePrevious, resetSwipeState, handleSwipedNext, handleSwipedPrevious]); // Ajout handleSwipedNext/Previous
